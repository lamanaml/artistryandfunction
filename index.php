      ...
      <div class="card-deck">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Professional content driven websites that are fully designed for all devices. .</p>
          </div>
        </div>
        <div class="card">
          <img src="https://picsum.photos/100/100" class="card-img-top" alt="...">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Develop relevant, marketable content from product pages to blogs and social media.</p>
   ...
   <a name="services"> <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel"></a>
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="https://about.fb.com/wp-content/uploads/2020/08/NRP-Discover_Support_Black-Owned_Businesses_on_FB_IG_banner_FINAL.jpg?fit=1920%2C1080" class="d-block w-100" alt="...">
...
<!-- ------------------Sign up------------------     -->
    ...
    <form class="form-inline " style="float:right; margin: -150px 500px 0px 0px; ">
      ...
      <button type="submit" class=" mb-2" style="margin-left: 30px;">Get Tips!</button>
    </form>
